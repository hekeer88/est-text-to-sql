...
class BasicDataset(object):
    def __init__(self, path_data, pre_test_result=None):
        ...
        self.path_test_schema_linking = os.path.join(self.path_data, "enc/test_schema-linking_est.jsonl")
        self.path_train_schema_linking = os.path.join(self.path_data, "enc/train_schema-linking_newnlp.jsonl")
