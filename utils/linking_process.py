...
class SpiderEncoderV2Preproc(abstract_preproc.AbstractPreproc):
    ...
    def save(self):
        ...
        for section, texts in self.texts.items():
            with open(os.path.join(self.data_dir, section + '_schema-linking_newnlp.jsonl'), 'w') as f:
                for text in texts:
    ...
    def load(self, sections):
        ...
        for section in sections:
            self.texts[section] = []
            with open(os.path.join(self.data_dir, section + '_schema-linking_newnlp.jsonl'), 'r') as f:
