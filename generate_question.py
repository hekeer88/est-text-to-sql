...
if __name__ == '__main__':
    ...
    print("Starting to format questions...")
    for question_json in tqdm(getattr(data, func_name)()):
        print(f"Processing question: {question_json['question'][:50]}...")
        ...
        print(f"Processed {question_json} question")
    ...
    path_generate = f"dataset/process/{args.data_type.upper()}-{args.split.upper()}_{prompt.name}_CTX-{args.max_ans_len}_ANS-{args.max_seq_len}-EST_FULL_transEX_engEX_02"
